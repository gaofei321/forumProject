        ...
        <form action="" class="form-horizontal">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <img id="avatar" src="http://oi2n24juy.bkt.clouddn.com/${sessionScope.curr_user.avatar}?imageView2/1/w/40/h/40" class="img-circle" alt="设置头像">
                </div>
            </div>
            <hr>
            ...
            $.post("/setting?action=avatar",{'fileKey':fileKey})
                .done(function (data) {
                  ...
                  if (data.state=='success') {
                      var url = "http://oi2n24juy.bkt.clouddn.com/" + fileKey;
